    ...
    <div className=" w-1/2 p-6   items-center">
      ...
      <div className="flex-grow">
        ...
        <form>
          ...
          <div className=" text-teal-500 font-bold">OR</div>
            ...
            onClick={signUpWithGoogle}>
                <img src="/googlelogo.png" alt="" className="w-5 mr-2" /> SignIn with Google
            </button>
        ...
        <p className="mt-2 text-sm text-gray-600">
          {!value ? (
              <Link to="/forgot-password" className="font-bold text-teal-500 hover:underline">
              Forgot Password?
            </Link>
          ):(
            <Link to="/doctor-forgot-password" className="font-bold text-teal-500 hover:underline">
            Forgot Password?
          </Link>
          )}
        ...
        {!value ? (
          ...
          <>
              Don't have an account?{' '}
              <Link to="/doctor-signup" className="font-bold text-teal-500 hover:underline">
               SIGN UP
            </Link>
          </>
        )}
      ...
      {!value && (
        <p className="font-bold text-gray-600 mt-4">
          Are you a Doctor?{'  '}
          <Link to="/doctor-login" className="font-bold text-teal-500 hover:underline" >
          <button className="font-bold text-teal-500 hover:underline"
